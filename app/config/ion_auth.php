...
$config['tables']['login_attempts']  = 'ci_login_attempts';
 ...
 */
$config['site_title']                 = getenv('SITE_NAME');       // Site Title, example.com
$config['admin_email']                = getenv('ADMIN_EMAIL'); // Admin Email, admin@example.com
