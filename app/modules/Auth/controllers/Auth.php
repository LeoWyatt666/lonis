...
class Auth extends MY_Controller
{
    ...
    public function register()
    {
        ...
        $this->form_validation->set_rules('username', 'lang:register_username_label', 'required');
        $this->form_validation->set_rules('email', 'lang:register_email_label', 'required|valid_email');
        $this->form_validation->set_rules('password', 'lang:register_password_label', 'required');
        $this->form_validation->set_rules('repassword', 'lang:register_repassword_label', 'required|matches[password]');
        ...
        if ($this->form_validation->run() == true) {
            ...
            if (!$this->ion_auth->username_check($username) || !$this->ion_auth->email_check($email)) {
                ...
                $this->session->set_flashdata('message', lang('register_exists'));
            }
        }

        $data['message'] = validation_errors() ?: $this->session->flashdata('message');
