<?php
    $this->set_css($this->default_theme_path.'/bootstrap3/css/bootstrap.min.css');
    $this->set_css($this->default_theme_path.'/bootstrap3/css/bootstrap-responsive.min.css');
    $this->set_css($this->default_theme_path.'/bootstrap3/css/style.css');
    
    $this->set_css($this->default_theme_path.'/bootstrap3/css/jquery-ui/flick/jquery-ui-1.9.2.custom.css');
    
    $this->set_js_lib($this->default_javascript_path.'/'.grocery_CRUD::JQUERY);
    
    //  JAVASCRIPTS - JQUERY-UI
    $this->set_js($this->default_theme_path.'/bootstrap3/js/jquery-ui/jquery-ui-1.9.2.custom.js');
...
if (!$this->is_IE7()) {
    ...
    $this->set_js($this->default_theme_path.'/bootstrap3/js/libs/bootstrap/bootstrap.min.js');
    $this->set_js($this->default_theme_path.'/bootstrap3/js/libs/bootstrap/application.js');
    //  JAVASCRIPTS - MODERNIZR
    $this->set_js($this->default_theme_path.'/bootstrap3/js/libs/modernizr/modernizr-2.6.1.custom.js');
    //  JAVASCRIPTS - TABLESORTER
    $this->set_js($this->default_theme_path.'/bootstrap3/js/libs/tablesorter/jquery.tablesorter.min.js');
    //  JAVASCRIPTS - JQUERY-COOKIE
    $this->set_js($this->default_theme_path.'/bootstrap3/js/cookies.js');
    //  JAVASCRIPTS - JQUERY-FORM
    $this->set_js($this->default_theme_path.'/bootstrap3/js/jquery.form.js');
    //  JAVASCRIPTS - JQUERY-NUMERIC
    $this->set_js($this->default_javascript_path.'/jquery_plugins/jquery.numeric.min.js');
    //  JAVASCRIPTS - JQUERY-PRINT-ELEMENT
    $this->set_js($this->default_theme_path.'/bootstrap3/js/libs/print-element/jquery.printElement.min.js');
    //  JAVASCRIPTS - JQUERY FANCYBOX
    $this->set_js($this->default_javascript_path.'/jquery_plugins/jquery.fancybox-1.3.4.js');
    //  JAVASCRIPTS - JQUERY EASING
    $this->set_js($this->default_javascript_path.'/jquery_plugins/jquery.easing-1.3.pack.js');
    
    //  JAVASCRIPTS - bootstrap3 - CONFIGURAÇÕES
    $this->set_js($this->default_theme_path.'/bootstrap3/js/app/bootstrap3.js');
    //  JAVASCRIPTS - JQUERY-FUNCTIONS
    $this->set_js($this->default_theme_path.'/bootstrap3/js/jquery.functions.js');
?>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="sDiv" id="quickSearchBox">
                            <div class="sDiv2">
                                ...
                                <input type="hidden" name="order_by[0]" id="hidden-sorting" value="<?php if (!empty($order_by[0])) {
?><?php echo $order_by[0]?><?php
                                                                                                   }?>" />
                                <input type="hidden" name="order_by[1]" id="hidden-ordering"  value="<?php if (!empty($order_by[1])) {
